...
describe('#breedDetailsFromFile', () => {
  ...
  it('provides, via callback, breed details for the Balinese breed', (done) => {
    breedDetailsFromFile('Balinese', (balinese) => {
      const expectedDescription = "Balinese are curious, outgoing, intelligent cats with excellent communication skills. They are known for their chatty personalities and are always eager to tell you their views on life, love, and what you’ve served them for dinner.";
      assert.equal(expectedDescription, balinese);
      done();
    });
  });
...
// const printBreedDetails = (breed => console.log('Return Value:', breed));
